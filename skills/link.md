...
### Step 5.5: Install CLAUDE.md

If the knowledge base repo does not already have a `CLAUDE.md` file at its root, create one using the Documentator template. This file instructs any LLM opened in the knowledge base repo on how to navigate and answer questions from it.
...
If a `CLAUDE.md` already exists, do not overwrite it -- the user may have customized it.
